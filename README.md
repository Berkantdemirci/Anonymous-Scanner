# Anonymous-Scanner
Anonymous Scanner is a Privacy oriented port scanning script. This script is very simple. It uses tor network with proxychains. A multi-threaded (using concurrent) port scanner that scans top 100 ports.
